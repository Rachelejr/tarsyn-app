  ...
  return (
    <div style={{ minHeight: '100vh', background: C.creme, padding: '0 0 64px' }}>
      <div style={{
        ...
        <img
          src="/unimunity-logo.png"
          alt="Unimunity"
          style={{ height: '52px', width: 'auto', margin: '0 auto 20px', display: 'block' }}
        />
      ...
      <div style={{ maxWidth: '680px', margin: '36px auto 0', padding: '0 24px', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '20px' }}>
        {workspaces.map(w => (
          ...
          >
            ...
            <div style={{ marginTop: '4px', color: C.dore, fontSize: '13px', fontWeight: 700 }}>Continue →</div>
          </button>
        ))}
      </div>
