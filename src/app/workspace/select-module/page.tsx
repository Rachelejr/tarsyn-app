...
const COMING_SOON_TITLES = ['Association', 'Investment', 'Agriculture', 'Foundation', 'Orphanage', 'Cooperative', 'Organization', 'Education', 'Health', 'Youth Club', 'Commerce', 'Sport'];
      ...
      <div style={{ background: `linear-gradient(135deg, ${C.dore} 0%, ${C.doreDark} 100%)`, padding: '20px 16px' }}>
        <div style={{ maxWidth: '1280px', margin: '0 auto', display: 'flex', alignItems: 'center', gap: '20px' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            <div>
              <img src="/images/UNIMUNITY-logo.png" alt="UNIMUNITY" style={{ height: '48px', width: 'auto', display: 'block' }} />
