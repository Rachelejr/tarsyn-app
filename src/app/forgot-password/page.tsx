        ...
        <div style={{background:'white',border:'1px solid #C7D9E5',borderRadius:'20px',padding:'52px 44px',width:'100%',maxWidth:'440px',boxShadow:'0 8px 40px rgba(110,147,172,0.10)'}}>
          ...
          {sent ? (
            <div style={{textAlign:'center'}}>
              ...
              <h2 style={{color:'#6E93AC',fontSize:'24px',fontWeight:'700',marginBottom:'12px'}}>Check your email!</h2>
              <p style={{color:'#6E93AC',fontSize:'14px',lineHeight:'1.7',marginBottom:'24px'}}>
            ...
            <>
              <div style={{textAlign:'center',marginBottom:'32px'}}>
                ...
                <h1 style={{color:'#6E93AC',fontSize:'26px',fontWeight:'700',marginBottom:'8px'}}>Forgot Password?</h1>
                <p style={{color:'#6E93AC',fontSize:'14px',lineHeight:'1.6'}}>
              ...
              <form onSubmit={handleReset}>
                ...
                <button type="submit" disabled={loading}
                  style={{width:'100%',padding:'14px',background:'#6E93AC',color:'#FBEEDD',border:'none',borderRadius:'10px',fontSize:'15px',fontWeight:'700',cursor:'pointer',marginBottom:'16px',opacity:loading?0.7:1}}>
                  {loading ? '⏳ Sending...' : '📧 Send Reset Link'}
                </button>
              </form>

              <a href="/login" style={{display:'block',textAlign:'center',color:'#6E93AC',fontSize:'13px',textDecoration:'none'}}>
                ← Back to Sign In
              </a>
            </>
          )}
