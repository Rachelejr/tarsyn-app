          ...
          {step === 1 && (
            <>
              ...
              <div style={{ marginBottom: '16px' }}>
                ...
                <input value={groupName} onChange={e => setGroupName(e.target.value)} placeholder="Ex: Family Sol, Community Tontine..."
              ...
              <div style={{ marginBottom: '16px' }}>
                ...
                <textarea value={description} onChange={e => setDescription(e.target.value.slice(0, 300))} placeholder="Brief description..." rows={3}
