...
const SUB_T: Record<string, Record<string, string>> = {
  en: {
    ...
    trial: '10-Day Free Trial', cancel: 'Cancel Anytime', secure: 'Secure Payments',
    monthly: 'Monthly', annual: 'Annual', save: 'SAVE 10%',
  ...
  fr: {
    ...
    trial: 'Essai gratuit de 10 jours', cancel: 'Annulez \u00e0 tout moment', secure: 'Paiements s\u00e9curis\u00e9s',
    monthly: 'Mensuel', annual: 'Annuel', save: '\u00c9CONOMISEZ 10%',
  ...
  ht: {
    ...
    trial: '10 Jou Es\u00e8 Gratis', cancel: 'Anile Nenp\u00f2t Kil\u00e8', secure: 'Peman Sekirize',
    monthly: 'Chak Mwa', annual: 'Chak Ane', save: 'EKONOMIZE 10%',
  ...
  es: {
    ...
    trial: 'Prueba Gratis de 10 D\u00edas', cancel: 'Cancela Cuando Quieras', secure: 'Pagos Seguros',
    monthly: 'Mensual', annual: 'Anual', save: 'AHORRA 10%',
  ...
  pt: {
    ...
    trial: 'Teste Gr\u00e1tis de 10 Dias', cancel: 'Cancele a Qualquer Momento', secure: 'Pagamentos Seguros',
    monthly: 'Mensal', annual: 'Anual', save: 'ECONOMIZE 10%',
...
const FAQ_T: Record<string, Record<string, { q: string; a: string }>> = {
  en: {
    ...
    freeTrial: { q: 'Is there a free trial?', a: 'Yes, every new account starts with a 10-day free trial with access to Starter features.' },
    ...
    annualDiscount: { q: 'Do you offer discounts for annual billing?', a: 'Yes, switching to annual billing saves you up to 10% compared to paying monthly.' },
  },
  fr: {
    ...
    freeTrial: { q: 'Y a-t-il un essai gratuit ?', a: 'Oui, chaque nouveau compte commence avec un essai gratuit de 10 jours donnant acc\u00e8s aux fonctionnalit\u00e9s Starter.' },
    ...
    annualDiscount: { q: 'Proposez-vous des r\u00e9ductions pour la facturation annuelle ?', a: 'Oui, passer \u00e0 la facturation annuelle vous fait \u00e9conomiser jusqu\u2019\u00e0 10% par rapport au paiement mensuel.' },
  },
  ht: {
    ...
    freeTrial: { q: '\u00c8ske gen yon es\u00e8 gratis?', a: 'Wi, chak nouvo kont k\u00f2manse ak yon es\u00e8 gratis 10 jou ki bay aks\u00e8 a fonksyonalite Starter yo.' },
    cancelAnytime: { q: 'Mwen ka anile nenp\u00f2t kil\u00e8?', a: 'Wi, pa gen kontra alont\u00e8m. Ou ka anile ab\u00f2nman w nenp\u00f2t kil\u00e8 soti nan paj sa a.' },
    annualDiscount: { q: '\u00c8ske nou ofri rab\u00e8 pou fakti chak ane?', a: 'Wi, chanje pou fakti chak ane f\u00e8 w ekonomize jiska 10% konpare ak peman chak mwa.' },
  },
  es: {
    ...
    freeTrial: { q: '\u00bfHay una prueba gratuita?', a: 'S\u00ed, cada cuenta nueva comienza con una prueba gratuita de 10 d\u00edas con acceso a las funciones de Starter.' },
    ...
    annualDiscount: { q: '\u00bfOfrecen descuentos por facturaci\u00f3n anual?', a: 'S\u00ed, cambiar a facturaci\u00f3n anual te ahorra hasta un 10% comparado con el pago mensual.' },
  },
  pt: {
    ...
    freeTrial: { q: 'Existe um teste gr\u00e1tis?', a: 'Sim, toda nova conta come\u00e7a com um teste gr\u00e1tis de 10 dias com acesso aos recursos do Starter.' },
    ...
    annualDiscount: { q: 'Voc\u00eas oferecem descontos para cobran\u00e7a anual?', a: 'Sim, mudar para cobran\u00e7a anual economiza at\u00e9 10% em compara\u00e7\u00e3o com o pagamento mensal.' },
  },
};
...
const PLANS: PlanDef[] = [
  ...
  },
  {
    ...
    members: 'Up to 2000 Members',
    groups: '50 groups',
    reports: 'Advanced administration',
    support: 'Dedicated support',
    additional: ['Everything in Pro', 'White label (Professional)'],
    ctaAction: 'checkout',
  ...
  },
  {
    ...
    reports: 'Advanced administration',
    support: 'SLA support',
    additional: ['Everything in Business', 'White label (Full Customization)', 'Dedicated onboarding'],
    ctaAction: 'contact',
              ...
              <tbody>
                {(() => {
                  ...
                  const FEATURE_INTRODUCED_AT: { label: string; introducedAt: string }[] = [
                    { label: 'Member invitations', introducedAt: 'starter' },
