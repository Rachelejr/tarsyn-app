    ...
    <div style={{ minHeight: '100vh', background: '#FAF0E6', fontFamily: 'Inter, sans-serif' }}>
      ...
      <div style={{ maxWidth: '1100px', margin: '0 auto', padding: '40px 24px' }}>
        ...
        <div style={{ background: 'white', borderRadius: '20px', padding: '28px', boxShadow: '0 2px 12px rgba(0,0,0,0.06)', marginBottom: '24px' }}>
          ...
          {groups.length === 0 ? (
            <p style={{ color: '#7A5068', fontSize: '14px' }}>No groups yet. <span onClick={() => router.push('/dashboard/create-group')} style={{ color: '#6B2D4E', fontWeight: 700, cursor: 'pointer', textDecoration: 'underline' }}>Create your first group</span></p>
          ) : (
