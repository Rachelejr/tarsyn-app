      ...
      html: `
        <div style="font-family:Inter,sans-serif;max-width:480px;margin:0 auto;padding:2rem;background:#FAF0E6;border-radius:16px;">
          ...
          <div style="background:#fff;border-radius:12px;padding:1.5rem;margin:1rem 0;">
            <p style="color:#7A5068;margin:0 0 12px;">Hello <strong style="color:#6B2D4E;">${name}</strong>,</p>
            <p style="color:#7A5068;margin:0;line-height:1.6;">${body}</p>
          </div>
          <div style="text-align:center;margin:1.5rem 0;">
            <a href="https://tarsyn-app.com/login" style="background:#6B2D4E;color:#FAF0E6;padding:14px 32px;border-radius:10px;text-decoration:none;font-weight:700;font-size:16px;display:inline-block;">
              Sign In to TARSYN
            </a>
          </div>
