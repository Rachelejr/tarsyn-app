      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        ...
        <div style={{ maxWidth: '1400px', margin: '0 auto', padding: '20px 28px 50px' }}>
          <div className="fade-up" style={{ display: 'grid', gridTemplateColumns: 'repeat(7, 1fr)', gap: '12px', marginBottom: '24px' }}>
            <div style={{ background: C.white, borderRadius: '12px', padding: '14px 12px', boxShadow: '0 2px 10px rgba(143,58,90,0.06)' }}>
          ...
          <div className="fade-up no-print" style={{ background: C.white, borderRadius: '12px', padding: '16px 18px', marginBottom: '16px', boxShadow: '0 2px 10px rgba(143,58,90,0.06)', display: 'flex', alignItems: 'center', gap: '12px', flexWrap: 'wrap' }}>
            <input
          ...
          <div className="fade-up" style={{ background: C.white, borderRadius: '14px', overflow: 'hidden', boxShadow: '0 2px 10px rgba(143,58,90,0.06)', marginBottom: '24px' }}>
          ...
          <div className="fade-up no-print" style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '16px', marginBottom: '24px' }}>
            <div style={{ background: C.white, borderRadius: '14px', padding: '18px 20px', boxShadow: '0 2px 10px rgba(143,58,90,0.06)' }}>
