...
export default function CreateTontinePage() {
  ...
  const handleSubmit = async () => {
    ...
    if (!contribution || parseFloat(contribution) <= 0) return setError('Invalid contribution amount.');
    ...
    try {
      const docRef = await addDoc(collection(db, 'tontines'), {
        ...
        currency, frequency, startDate, commission, rules, confidential, language,
