  ...
  return (
    <div style={{ minHeight: '100vh', background: '#FAF0E6', fontFamily: 'Inter, sans-serif' }}>
      ...
      <div style={{ maxWidth: '800px', margin: '0 auto', padding: '40px 24px' }}>
        ...
        <p style={{ color: '#7A5068', fontSize: '15px', margin: '0 0 32px' }}>{groupName} · Upload and manage group documents</p>
        ...
        <div style={{ background: 'white', borderRadius: '16px', padding: '24px', marginBottom: '24px', boxShadow: '0 2px 12px rgba(0,0,0,0.06)' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px', marginBottom: '16px' }}>
            <div>
              <label style={{ color: '#7A5068', fontSize: '13px', display: 'block', marginBottom: '6px' }}>Category</label>
            ...
            <div>
              <label style={{ color: '#7A5068', fontSize: '13px', display: 'block', marginBottom: '6px' }}>File</label>
          ...
          {uploading && (
            <div>
              <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '6px' }}>
                <span style={{ color: '#7A5068', fontSize: '13px' }}>Uploading...</span>
                <span style={{ color: '#6B2D4E', fontSize: '13px', fontWeight: 700 }}>{progress}%</span>
              </div>
              <div style={{ background: '#FAF0E6', borderRadius: '999px', height: '8px' }}>
                  ...
                  <div key={d.id} style={{ background: 'white', borderRadius: '14px', padding: '14px 20px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', boxShadow: '0 2px 8px rgba(0,0,0,0.05)' }}>
                    ...
                    <div style={{ display: 'flex', gap: '8px' }}>
                      <a href={d.url} target="_blank" rel="noreferrer"
                        style={{ background: '#6B2D4E', color: '#FAF0E6', padding: '7px 14px', borderRadius: '8px', fontSize: '12px', fontWeight: 600, textDecoration: 'none' }}>
                        ⬇️ Download
                      </a>
        ...
        {docs.length === 0 && !uploading && (
          <div style={{ background: 'white', borderRadius: '16px', padding: '48px', textAlign: 'center' }}>
            ...
            <p style={{ color: '#7A5068', fontSize: '15px' }}>No documents yet. Upload your first file!</p>
          </div>
        )}
      </div>
    </div>
